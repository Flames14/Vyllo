...
import com.example.android.data.download.PlaylistEntity
import com.example.android.data.download.PlaylistSongEntity
...
import com.example.android.data.download.DownloadDatabase
import com.example.android.data.download.DownloadEntity
import com.example.android.data.download.DownloadStatus
import com.example.android.service.DownloadWorker
import java.io.File
...
object MusicRepository {
    ...
    suspend fun getLyrics(title: String, artist: String, durationSecs: Long, videoUrl: String = ""): com.example.android.data.LyricsResponse? = withContext(Dispatchers.IO) {
            ...
            if (savedId != null) {
                ...
                if (savedResult != null) {
                    ...
                    return@withContext LyricsResponse(
                        ...
                        lyricsStatus = com.example.android.data.LyricsStatus(
     ...
     */
    private fun parseVttToSyncedLyrics(vttContent: String): List<com.example.android.data.SyncedLyricLine> {
        val lines = vttContent.lines()
        val syncedLyrics = mutableListOf<com.example.android.data.SyncedLyricLine>()
            ...
            if (match != null) {
                ...
                if (currentStartTime != null && currentText.isNotEmpty()) {
                    ...
                    if (cleanText.isNotBlank()) {
                        syncedLyrics.add(com.example.android.data.SyncedLyricLine(currentStartTime, cleanText))
                    }
                    currentText.clear()
                }
